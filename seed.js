...
const seedDB = async () => {
  try {
    ...
    await User.deleteMany({ 
      $or: [
        { email: { $in: ['abbas@test.com', 'admin@test.com', 'driver@test.com', 'owner@test.com', 'accountant@test.com'] } },
        { phone: { $in: ['07700000000', '07700000001', '07700000002', '07700000003', '07700000004'] } }
      ]
    });
